(function () {
    ...
    describe('Cycle Time Service', function () {
        ...
        it('wait times for single issue are correct', function () {
            ...
            var cycleTimes = cycleTimeService.getCycleTimes([issue]);
            expect(cycleTimes.inProgress.waitTime).toBe(2);
            expect(cycleTimes.review.waitTime).toBe(1);
            expect(cycleTimes.testing.waitTime).toBe(0.1);
            expect(cycleTimes.merge.waitTime).toBe(0);
        });
    });
})();