    ...
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        var render = function(data) {
          ...
          var theseAreTheDaysOfOurLives = data.coords.filter(function(d) { return new Date(xValue(d)) < new Date(); });

          console.log(theseAreTheDaysOfOurLives);

          svg.append("path")
            .datum(theseAreTheDaysOfOurLives)
            .attr({ d: line });

          svg.selectAll('circle')
            .data(theseAreTheDaysOfOurLives)
            .enter()
              .append('circle')
              .attr({
