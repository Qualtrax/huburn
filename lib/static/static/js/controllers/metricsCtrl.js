(function () {
    ...
    function metricsCtrl($routeParams, $q, metricService, gitHubService, cycleTimeService) {
        ...
        vm.calculateLeftYellowPercentage = function calculateYellowPercentage(statistic, standardDeviationSummary) {
            var leftRedValue = calculateLeftRedValue(statistic);
        ...
        vm.calculateGreenPercentage = function calculateGreenPercentage(statistic, standardDeviationSummary) {
            ...
            var greenValue = (greenValue + statistic.standardDeviation - leftYellowValue) / standardDeviationSummary.collectiveRange;

            return convertToPercentage(greenValue);
        };

        vm.calculateRightYellowPercentage = function calculateYellowPercentage(statistic, standardDeviationSummary) {
            var rightYellowRange = statistic.standardDeviation / standardDeviationSummary.collectiveRange;
