(function() {
  angular.module('huburn').controller('burndownCtrl', ['$scope', '$http', 'burndownCalculator', function ($scope, $http, burndownCalculator) {
    $scope.milestones = [];
    ...
    githubRequest($http, { path: '/repos/qualtrax/qualtrax/milestones', state: 'closed', sort: 'due_date', direction: 'desc' }, function(milestones) {  
