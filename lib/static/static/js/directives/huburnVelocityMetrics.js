      ...
      return {
        ...
        link: function(scope, element, attrs) {
          ...
          function renderBadges(data, x, y) {
            ...
            var numberBrokenBuilds = (velocityMilestones.map(brokenBuilds).reduce(sum) / milestonesInVelocity).toFixed(1);
            appendBadge(badges, 100, 50, "Broken Builds", numberBrokenBuilds, noValueClass);
          };
          ...
          function brokenBuilds(m) { return m.metadata.brokenBuilds; };
